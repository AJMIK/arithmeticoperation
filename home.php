      ...
      <div class="container">
          <div class="row">
              ...
              <div class="col col-12 col-sm-8">
                  <center><p class="text">MATH GAMES</p></center>
                ...
                <div class="col col-12 col-sm-4"></div>
                         ...
                         <div class="col col-12 col-sm-3">
                            <center><p class="text">ABOUT</p></center>
                            <div class="card" style="width: 18rem;">
                                <img src="image/add.jpg" class="card-img-top" alt="...">
                                <div class="card-body">
                                  <h5 class="card-title">ADDITION</h5>
                                  <p class="card-text">Addition is a mathematical operation. It is a process or action that you do with numbers.
                                  ...
                                  <a href="#" class="btn btn-primary">Go somewhere</a>
                                    ...
                                    <div class="card" style="width: 18rem;">
                                        <img src="image/sub.jpg" class="card-img-top" alt="...">
                                        <div class="card-body">
                               ...
                               <div class="card" style="width: 18rem;">
                                <img src="image/mul.jpg" class="card-img-top" alt="...">
                                <div class="card-body">
                                 ...
                                 <a href="#" class="btn btn-primary">Go somewhere</a>
                                  ...
                                  <div class="card" style="width: 18rem;">
                                    <img src="image/div.jpg" class="card-img-top" alt="...">
                                    <div class="card-body">
